...
plugins=(git fzf zsh-syntax-highlighting zsh-history-substring-search z zsh-autosuggestions zsh-vi-mode history-substring-search)
...
alias cpwd="pwd | tr -d '\n' | pbcopy && echo 'pwd copied to clipboard'" #show
alias pwdc="pwd | tr -d '\n' | pbcopy && echo 'pwd copied to clipboard'" #show
alias ls="ls --color -l -a -h" #show
alias grep="grep -n --color" #show
alias mkdir="mkdir -pv" #show
alias ping="ping -c 5" #show
alias h="history" # last 10 history commands #show
...
ddc=/Users/nolfonzo/Documents #show
...
source ~/.config/zsh/hash_functions.zsh
